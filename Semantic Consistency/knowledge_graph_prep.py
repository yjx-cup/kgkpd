...
file_path = os.path.join(path_project, "Semantic Consistency/ConceptNet/Assertions57/assertions.csv")
lookup_filepath = os.path.join(path_project, "Semantic Consistency/KG_lookup.csv")
cropped_filepath = os.path.join(path_project, "Semantic Consistency/KG_crop.csv")
