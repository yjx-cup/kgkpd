...
from nets.model import CenterNet_HourglassNet, CenterNet_Resnet50, CenterNet_EfficentNetV2, CenterNet_GhostNetV3, CenterNet_Repvit
...
class KGKPD(object):
    ...
    def generate(self, onnx=False):
        ...
        assert self.backbone in ['resnet50', 'hourglass', "EfficientNetV2", "GhostNetV3", "RepVit"]
        if self.backbone == "resnet50":
            self.net = CenterNet_Resnet50(num_classes=self.num_classes, pretrained=False)
        elif self.backbone == "EfficientNetV2":
            self.net = CenterNet_EfficentNetV2(num_classes=self.num_classes, pretrained=False)
        elif self.backbone == "RepVit":
            self.net = CenterNet_Repvit(num_classes=self.num_classes, pretrained=False)
        elif self.backbone == "GhostNetV3":
            self.net = CenterNet_GhostNetV3(num_classes=self.num_classes, pretrained=False)
        else:
